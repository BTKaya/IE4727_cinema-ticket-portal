...
if ($date && $time) {
    ...
    foreach ($rows as $r) {
        ...
        foreach ($taken as $s) $bookedSeats[] = $s;
    }
}
    ...
    <div class="seat-container">
        ...
        <?php foreach ($rows as $r): ?>
            <div class="seat-row">
                ...
                <?php 
                if ($layout == 1) $seats = range(1,8);
                else $seats = range(1,10);
                ...
                foreach ($seats as $i):
                    ...
                    if ($layout == 1 && in_array($i,[2,4,6])) echo "<div class='aisle-gap'></div>";
                    if ($layout == 2 && in_array($i,[2,8])) echo "<div class='aisle-gap'></div>";
                endforeach;
                ?>
            </div>
        <?php endforeach; ?>
